...
def run_experiment_2(num_runs):
    ...
    resolutions = {5000: [1.0, 3.0, 6.0, 10.0, 30.0],
                   500: [1.0, 3.0, 6.0, 10.0, 30.0],
                   50000: [1.0, 3.0, 6.0, 10.0, 30.0]}
...
if __name__ == '__main__':
    ...
    resolutions = np.array([0.1, 1.0, 3.0, 6.0, 10.0, 30.0])
    ...
    # fill_bellman_error()
    experiment3(15, auto_res=True, folder="", c=0.01)
