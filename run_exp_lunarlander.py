...
def run_experiment_2(num_runs):
    ...
    resolutions = {5000: [1.0, 2.0, 4.0, 6.0, 10.0, 20.0],
                   500: [1.0, 2.0, 4.0, 6.0, 10.0, 20.0],
                   50000: [1.0, 2.0, 4.0, 6.0, 10.0, 20.0]}
...
if __name__ == '__main__':
    ...
    resolutions = np.array([1.0, 2.0, 4.0, 6.0, 10.0, 20.0])

    model_counts = [10] * 3
    TOP_Q_FLOOR = 230
    NORMAL_Q_CEILING = 180
    NORMAL_Q_FLOOR = -200
    ...
    # experiment5(10, auto_res=True, folder="till_01_20/", c=0.00)
    experiment5(10, auto_res=True, folder="", c=0.00)
