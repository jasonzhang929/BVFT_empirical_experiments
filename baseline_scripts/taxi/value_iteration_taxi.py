...
np.save(dir_path + F'/../../data/taxi/ENV_T_epsilon_{transition_epsilon}.npy', T)
np.save(dir_path + F'/../../data/taxi/ENV_R_epsilon_{transition_epsilon}.npy', R)

T = np.load(dir_path + F'/../../data/taxi/ENV_T_epsilon_{transition_epsilon}.npy')
...
iters = i + 1
np.save(dir_path + F'/../../data/taxi/OPTIMAL_Q_GAMMA_{gamma}.npy', Q)
