...
def run_experiment_2(num_runs):
    ...
    resolutions = {5000: [0.05, 0.1, 0.2, 0.4, 0.3, 0.5, 1.0],
                   500: [0.05, 0.1, 0.2, 0.4, 0.3, 0.5, 1.0],
                   50000: [0.05, 0.1, 0.2, 0.4, 0.3, 0.5, 1.0]}
...
if __name__ == '__main__':
    ...
    ENV_NAME = 'SeaquestNoFrameskip-v0'
    ...
    resolutions = np.array([0.05, 0.1, 0.2, 0.4, 0.3, 0.5, 1.0])

    model_counts = [10]*2
    TOP_Q_FLOOR = 400.0
    NORMAL_Q_CEILING = 400
    NORMAL_Q_FLOOR = 150
    model_gap = 10
